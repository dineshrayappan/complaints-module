...
export const AdminOversightDashboard = ({ onViewComplaint }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="p-5 rounded-3xl bg-gradient-to-r from-amber-500/10 via-orange-500/5 to-rose-500/10 border border-amber-300/40 dark:border-amber-700/30 flex flex-col lg:flex-row lg:items-center justify-between gap-4 shadow-sm backdrop-blur-md">
        <div className="flex items-start sm:items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-amber-500 to-rose-500 text-white flex items-center justify-center shadow-md shadow-orange-500/20 shrink-0">
            <Crown className="w-6 h-6" />
          </div>
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h2 className="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                Executive Operations & Accountability Control Center
              </h2>
              <span className="px-2 py-0.5 text-[10px] font-extrabold uppercase tracking-wider rounded-md bg-amber-100 text-amber-900 dark:bg-amber-900/60 dark:text-amber-200 border border-amber-300 dark:border-amber-700">
                Live Factory Monitoring
              </span>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5">
              Continuous monitoring of Auditor defect logging vs Supervisor defect resolution • Bottlenecks & Inaction detection
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 text-xs font-semibold shadow-2xs transition-colors cursor-pointer"
          >
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-extrabold uppercase tracking-wider text-slate-900 dark:text-white">
              Inaction & Bottleneck Radar (What Needs Immediate Attention)
            </h3>
          </div>
          <span className="text-[11px] text-slate-400 font-mono">12–24h SLA Enforcement</span>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/90 dark:border-slate-800 p-5 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
            ...
            >
              All Events ({activityStream.length})
            </button>
            <button
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            placeholder="Search by ticket ID (e.g. CMP-10492), actor name, department, or action..."
