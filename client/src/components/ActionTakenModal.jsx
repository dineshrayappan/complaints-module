      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl overflow-hidden my-6 transition-colors">
        ...
        <div className="flex items-center justify-between px-6 py-5 bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-950/60 dark:text-emerald-400 flex items-center justify-center border border-emerald-200 dark:border-emerald-800">
              <FileCheck className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white tracking-tight">
                  Submit Defect Rectification Proof
                </h2>
                <span className="font-mono text-xs font-bold text-slate-700 dark:text-cyan-400 bg-slate-200/80 dark:bg-slate-950 px-2 py-0.5 rounded border border-slate-300 dark:border-slate-800">
                  {complaint.complaintId}
                </span>
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Action Taken • Mandatory After Photo • Submits for Audit Verification
              </p>
            </div>
          </div>
          <button
